...
function IntranetOne2(params = {}) {
  ...
  this.compileBase = (cb = () => {}) => {
    ...
    mix.babel(
      [
        src.io.root + "services/category.js",
        dep.slimSelect + "slimselect.min.js",
      ],
      dest.io.js + "io-category.min.js"
    );

    mix.styles(
      [
        src.io.css + "services/category.min.js",
        dep.slimSelect + "slimselect.min.css",
        src.io.css + "slimselect.css",
      ],
      dest.io.css + "io-category.min.css"
    );
  ...
  this.compileIO = (cb = () => {}) => {
    mix.copyDirectory(
      src.io.vendors + "glyphter-font/fonts/",
      dest.root + "fonts"
    );
    ...
    // Copy language files
    mix.copy(
      src.io.vendors + "datatables/datatables-pt-br.json",
    ...
    mix.styles(
      [
        src.vendors +
          "formvalidation-dist-v1.3.0/dist/css/formValidation.min.css",
    ...
    mix.scripts(
      [dep.sweetalert2 + "sweetalert2.min.js", dep.io.toastr + "toastr.min.js"],
      ...
      new MergeIntoSingleFilePlugin({
        files: {
          "io/js/io-form-validation.min.js": [
            ...
            src.vendors +
              "formvalidation-dist-v1.3.0/dist/js/FormValidation.full.min.js",
            src.vendors +
              "formvalidation-dist-v1.3.0/dist/js/plugins/Bootstrap.min.js",
          ],
        },
      })
    );
    ...
    mix.babel(
      [dep.dv_holdonjs + "js/HoldOn.min.js", dep.io.toastr + "toastr.min.js"],
  ...
  this.compileFE = () => {
    mix.copyDirectory(
      $.src.fe.vendors + "glyphter-font/fonts/",
      $.dest.root + "fonts"
    );
    ...
    mix.copyDirectory(
      $.src.fe.root + "images/favicon",
      $.dest.root + "images/favicon"
    );
