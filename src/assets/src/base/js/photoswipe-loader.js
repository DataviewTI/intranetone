initPhotoSwipeFromDOM = function(gallerySelector){
  ...
  function manageVideos(gallery){
    ...
    let obj = $(gallery.currItem.html).find('.pswp__video').first();
    if(obj.length){
            ...
            let _ytp = new YT.Player(obj.attr('id'),{
              events: {
                onReady: function(_t){
                  ...
                  let goto = parseInt(moment.duration(obj.attr('data-start-at')).asSeconds());
      ...
      if(vsource == 'facebook'){
        try{
          FB.api(
            "/"+obj.attr('id')+'?fields=thumbnails,description,length,embed_html,format,title&access_token='+IntranetOne.conf.social_media.facebook.long_token,
            function (ret){
