<?php
	// General
	$moxieManagerConfig['general.license'] = 'EPHX-PROD-2349-SD0F-23N4-349J-WE0R-JT43';
	...
	$moxieManagerConfig['general.language'] = 'pt-BR';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "dataview", "password" => "yv7scr", "groups" => array("administrator"))
	);
