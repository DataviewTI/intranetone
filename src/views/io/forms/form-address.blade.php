    ...
    <div class = 'row'>
      <div class="col-sm-2 col-xs-12 pr-0">
        <div class="form-group">
          ...
          <input name = '{{$prefix}}zipCode' type = 'tel' id = '{{$prefix}}zipCode' class = 'form-control form-control-lg' />
        </div>
      </div>
      <div class="col-sm-6 col-xs-12 pr-0">
        <div class="form-group">
          ...
          <input name = '{{$prefix}}address' type = 'text' id = '{{$prefix}}address' class = 'form-control form-control-lg' />
        </div>
      </div>
      <div class="col-sm-4 col-xs-12">
        <div class="form-group">
          <label for = '{{$prefix}}address2' class="bmd-label-floating">Bairro</label>
          <input name = '{{$prefix}}address2' type = 'text' id = '{{$prefix}}address2' class = 'form-control form-control-lg' />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class = 'row'>
      <div class="col-10">
        <div class="form-group">
          ...
          <input name = '{{$prefix}}city_id' type = 'hidden' id = '{{$prefix}}city_id' class = 'form-control form-control-lg' />
        </div>
      </div>
      <div class="col-2 pl-0">
        <div class="form-group">
          <label for = '{{$prefix}}state' class="bmd-label-floating">UF</label>
          <input name = '{{$prefix}}state' type = 'text' id = '{{$prefix}}state' always-send class = 'form-control form-control-lg' disabled/>
        </div>
      </div>
    </div>
  </div>
